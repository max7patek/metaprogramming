...
\textbf {Credit Hours:} 1 \hspace{5mm} \textbf{Time:} TBD \hspace{5mm} \textbf{Room:} TBD\\
...
\begin{itemize}
	\item \textbf {Lecture}
		...
		\begin{itemize}
			\item There will mostly be an assignment for each week. 
		...
		\begin{itemize}
		\item $50\%$ off for up to 1 week late.
		\end{itemize}
...
11 & Language Metaprogramming &  writeup \\
12 & Conclusion & none
\end{tabular}
\end{center}
